...
-   **Distributional Shift:** The distribution of transaction volumes and values shifted significantly upward across the three periods, as illustrated by the normalized boxplots.

![Figure 1: Normalized Boxplots of Transaction Values by Period](visualizations/value_boxplot_zscore_by_period.png)

![Figure 2: Normalized Boxplots of Transaction Volumes by Period](visualizations/volume_boxplot_zscore_by_period.png)
...
![Figure 3: Correlation Heatmap](visualizations/correlation_heatmap.png)
...
![Figure 4: SARIMA Forecast (Model 1) vs. Actual Data](visualizations/sarima_forecast_pre-covid_vs_during-covid.png)
...
![Figure 5: SARIMA Forecast (Model 2) vs. Actual Data](visualizations/sarima_forecast_(pre+during)-covid_vs_post-covid.png)
